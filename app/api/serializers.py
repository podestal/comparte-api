...
class StreamingServiceAccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'owner', 'service', 'username', 'password', 'price_per_screen', 'total_screens', 'available_screens']  

class ScreenSubscriptionSerializer(serializers.ModelSerializer):

    class Meta:
        model = models.ScreenSubscription
        fields = ['id', 'streaming_account', 'user', 'screen_number', 'is_active', 'subscription_date', 'payment_status']  
